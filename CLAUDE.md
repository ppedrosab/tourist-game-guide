...
- Los personajes tienen que ser propios de la ciudad: personas reales históricas o figuras
  ...
  **Los personajes que ya hay no se tocan** (decisión del usuario): la norma vale para los nuevos. Un tipo
  nuevo solo se cambia por una persona real si esa persona fue de verdad eso mismo (un carpintero famoso…).
